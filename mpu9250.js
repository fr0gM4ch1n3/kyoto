...
var mpu9250 = function(cfg) {
	...
	var config = Object.assign({}, _default, cfg);
	this._config = config;
...
mpu9250.prototype.initialize = function() {
	this.i2c = getLOCAL_I2C(this._config.i2c, MPU9250.I2C_ADDRESS_AD0_LOW);
	this.debug.Log('INFO', 'Initialization MPU9250 ....');

	// clear configuration
	this.i2c.writeBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_1, MPU9250.PWR1_DEVICE_RESET_BIT, 1);
	this.debug.Log('INFO', 'Reset configuration MPU9250.', this.i2c.readByte(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_1).toString(16));
	sleep.usleep(10000);
	...
	console.log(typeof this.testDevice(), this.testDevice(), this.getIDDevice(), this.getIDDevice().toString(16));
...
mpu9250.prototype.enableMagnetometer = function() {
	if (this.i2c) {
		...
		console.log('##############################################')
		console.log('##############################################')
		console.log(this.getByPASSEnabled())
...
mpu9250.prototype.getIDDevice = function() {
	if (this.i2c) {
		return this.i2c.readByte(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.WHO_AM_I);
	}
	return false;
};
...
mpu9250.prototype.getTemperature = function() {
	if (this.i2c) {
		var buffer = this.i2c.readBytes(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.TEMP_OUT_H, 2, function() {});
...
mpu9250.prototype.getMotion6 = function() {
	if (this.i2c) {
		var buffer = this.i2c.readBytes(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.ACCEL_XOUT_H, 14, function() {});
...
mpu9250.prototype.getAccel = function() {
	if (this.i2c) {
		var buffer = this.i2c.readBytes(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.ACCEL_XOUT_H, 6, function() {});
		var aCal = this._config.accelCalibration;
...
mpu9250.prototype.getGyro = function() {
	if (this.i2c) {
		var buffer = this.i2c.readBytes(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.GYRO_XOUT_H, 6, function() {});
		var gCal = this._config.gyroBiasOffset;
		return [
...
mpu9250.prototype.getSleepEnabled = function() {
	if (this.i2c) {
		return this.i2c.readBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_1, MPU9250.PWR1_SLEEP_BIT);
	}
	return false;
};
...
mpu9250.prototype.getClockSource = function() {
	if (this.i2c) {
		return this.i2c.readByte(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_1) & 0x07;
	}
	return false;
};
...
mpu9250.prototype.getFullScaleGyroRange = function() {
	if (this.i2c) {
		var byte = this.i2c.readByte(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_GYRO_CONFIG);
		byte = byte & 0x18;
		byte = byte >> 3;
		return byte;
	}
...
mpu9250.prototype.getGyroPowerSettings = function() {
	if (this.i2c) {
		var byte = this.i2c.readByte(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_2);
		byte = byte & 0x07;
		return [
			(byte >> 2) & 1,    // X
			(byte >> 1) & 1,    // Y
...
mpu9250.prototype.getFullScaleAccelRange = function() {
	if (this.i2c) {
		var byte = this.i2c.readByte(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_ACCEL_CONFIG_1);
		byte = byte & 0x18;
		byte = byte >> 3;
		return byte;
	}
...
mpu9250.prototype.getByPASSEnabled = function() {
	if (this.i2c) {
		return this.i2c.readBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_INT_PIN_CFG, MPU9250.INTCFG_BYPASS_EN_BIT);
	}
	return false;
};
...
mpu9250.prototype.getI2CMasterMode = function() {
	if (this.i2c) {
		return this.i2c.readBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_USER_CTRL, MPU9250.USERCTRL_I2C_MST_EN_BIT);
	}
	return false;
};
...
mpu9250.prototype.setClockSource = function(adrs) {
	if (this.i2c) {
		return this.i2c.writeBits(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_1, MPU9250.PWR1_CLKSEL_BIT, MPU9250.PWR1_CLKSEL_LENGTH, adrs);
	}
	return false;
};
...
mpu9250.prototype.setFullScaleGyroRange = function(adrs) {
	if (this.i2c) {
		...
		return this.i2c.writeBits(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_GYRO_CONFIG, MPU9250.GCONFIG_FS_SEL_BIT, MPU9250.GCONFIG_FS_SEL_LENGTH, adrs);
	}
	return false;
};
...
mpu9250.prototype.setFullScaleAccelRange = function(adrs) {
	if (this.i2c) {
		...
		return this.i2c.writeBits(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_ACCEL_CONFIG_1, MPU9250.ACONFIG_FS_SEL_BIT, MPU9250.ACONFIG_FS_SEL_LENGTH, adrs);
	}
	return false;
};
...
mpu9250.prototype.setSleepEnabled = function(bool) {
	var val = bool ? 1 : 0;
	if (this.i2c) {
		return this.i2c.writeBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_PWR_MGMT_1, MPU9250.PWR1_SLEEP_BIT, val);
	}
	return false;
};
...
mpu9250.prototype.setI2CMasterModeEnabled = function(bool) {
	var val = bool ? 1 : 0;
	if (this.i2c) {
		return this.i2c.writeBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_USER_CTRL, MPU9250.USERCTRL_I2C_MST_EN_BIT, val);
	}
	return false;
};
...
mpu9250.prototype.setByPASSEnabled = function(bool) {
	var adrs = bool ? 1 : 0;
	if (this.i2c) {
		return this.i2c.writeBit(MPU9250.I2C_ADDRESS_AD0_LOW, MPU9250.RA_INT_PIN_CFG, MPU9250.INTCFG_BYPASS_EN_BIT, adrs);
	}
	return false;
};
...
mpu9250.prototype.printSettings = function() {
    ...
    this.debug.Log('INFO', '--> BYPASS enabled: ' + (this.getByPASSEnabled() !== false ? 'Yes' : 'No'));
...
mpu9250.prototype.reset = function() {
	this.i2c.writeBits(0x68, 0x6B, 1, 8, 0x80); 
}
...
var ak8963 = function(config, callback) {
	...
	this.i2c = getLOCAL_I2C(this._config.i2c, AK8963.ADDRESS);
	sleep.usleep(10000);
...
ak8963.prototype.getDataReady = function() {
	if (this.i2c) {
		return this.i2c.readBit(AK8963.ADDRESS, AK8963.ST1, AK8963.ST1_DRDY_BIT);
	}
	return false;
};
...
ak8963.prototype.getIDDevice = function() {
	if (this.i2c) {
		return this.i2c.readByte(AK8963.ADDRESS, AK8963.WHO_AM_I);
	}
	return false;
};
...
ak8963.prototype.getSensitivityAdjustmentValues = function () {
	...
	// Get the ASA* values
	this.asax = ((this.i2c.readByte(AK8963.ADDRESS, AK8963.ASAX) - 128) * 0.5 / 128 + 1);
	this.asay = ((this.i2c.readByte(AK8963.ADDRESS, AK8963.ASAY) - 128) * 0.5 / 128 + 1);
	this.asaz = ((this.i2c.readByte(AK8963.ADDRESS, AK8963.ASAZ) - 128) * 0.5 / 128 + 1);
...
ak8963.prototype.getMagAttitude = function() {
	...
	// Get the actual data
	var buffer = this.i2c.readBytes(AK8963.ADDRESS, AK8963.XOUT_L, 6, function(e, r) {});
	...
	var self = this;
	setTimeout(function () {
		self.i2c.readByte(AK8963.ADDRESS, AK8963.ST2);
	}, 0);
...
ak8963.prototype.getCNTL = function() {
	if (this.i2c) {
		return this.i2c.readByte(AK8963.ADDRESS, AK8963.CNTL);
	}
	return false;
};
...
ak8963.prototype.setCNTL = function(mode) {
	if (this.i2c) {
		return this.i2c.writeBytes(AK8963.ADDRESS, AK8963.CNTL, [mode], function(){});
	}
	return false;
};
...
var getLOCAL_I2C = function (i2c1) {
	var LOCAL_I2C = new (function () {});
	LOCAL_I2C.bitMask = function(bit, length) {
		return ((1 << length) - 1) << bit;
	};

	LOCAL_I2C.readBytes = function(DEVICE_ADRS, adrs, length, callback) {
		callback = callback || function() {};
		// var buf = this.readBytes(adrs, 1, callback);
		var buf = new Buffer(length);
		i2c1.readI2cBlockSync(DEVICE_ADRS, adrs, length, buf);
		return buf;
	};

	LOCAL_I2C.readByte = function(DEVICE_ADRS, adrs, callback) {
		callback = callback || function() {};
		// var buf = this.readBytes(adrs, 1, callback);
		var buf = new Buffer(1);
		i2c1.readI2cBlockSync(DEVICE_ADRS, adrs, 1, buf);
		// console.log('LOCAL_I2C.readByte', buf)
		return buf[0];
	};
	 ...
	 */
	LOCAL_I2C.readBit = function(DEVICE_ADRS, adrs, bit, callback) {
		var buf = this.readByte(DEVICE_ADRS, adrs, callback);
		// console.log('r1', buf);
		return (buf >> bit) & 1;
	};
	 ...
	 * @param  {Function} callback (Optional) callback
	 */
	LOCAL_I2C.writeBits = function(DEVICE_ADRS, adrs, bit, length, value, callback) {
		callback = callback || function() {};
		var oldValue = this.readByte(DEVICE_ADRS, adrs);
		...
		// console.log('w1', (bit + length), (bit + length) / 8, Math.ceil((bit + length) / 8))
		var byteLength = Math.ceil((bit + length) / 8);
		var buf = new Buffer(byteLength);
		buf.writeUInt8(value, 0);


		// console.log('w2', DEVICE_ADRS.toString(16), adrs.toString(16), bit, length, value);
		// console.log('w3', oldValue.toString(16), mask.toString(16), newValue.toString(16), buf);

		// console.log('w4', DEVICE_ADRS.toString(16), adrs.toString(16), byteLength, buf)


		return i2c1.writeI2cBlockSync(DEVICE_ADRS, adrs, byteLength, buf);
		// console.log('w5', this.readByte(DEVICE_ADRS, adrs));
	};
	 ...
	 * @param  {Function} callback (Optional) callback
	 */
	LOCAL_I2C.writeBit = function(DEVICE_ADRS, adrs, bit, value, callback) {
		return this.writeBits(DEVICE_ADRS, adrs, bit, 1, value, callback);
	};
